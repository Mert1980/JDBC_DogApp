...
import be.intecbrussel.data.DogDAO;
import be.intecbrussel.data.UserDAO;
import be.intecbrussel.model.Dog;
import be.intecbrussel.model.DogShelter;
import be.intecbrussel.model.User;
import be.intecbrussel.util.UserValidator;
